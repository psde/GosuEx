...
* <strike>Set the workcopy/clone path (i.e. D:\Visual Studio 2008\libs\Gosu\) to the environment variable GOSU_DIR. To check if it's working, run cmd and try 'cd %GOSU_DIR%'.</strike> Not needed anymore.
